...
║    free -h           → Memória
║    df -h             → Tárhely
║    cat /tmp/ssh-info.txt  → Ez az info
║
╚══════════════════════════════════════════════════════╝
EOF
        
        echo -e "${GREEN}  ✓ SSH/SFTP tunnel aktív!${NC}"
        echo -e "${GREEN}  ✓ Info: cat /tmp/ssh-info.txt${NC}"
    else
...
echo -e "${CYAN}══════════════════════════════════════════${NC}"
echo ""
echo -e "${YELLOW}📋 Gyors info parancsok:${NC}"
echo -e "   ${BLUE}cat /tmp/ssh-info.txt${NC}      (SSH/SFTP adatok)"
